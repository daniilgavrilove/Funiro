...
(() => {
  ...
  const N = {
    loopCreate: function () {
      ...
      for (let e = 0; e < a.length; e += 1)
        n.append(w(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
  ...
  function q(e) {
    ...
    if (!s.allowTouchMove)
      return (
        w(l.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
  ...
  window.addEventListener("load", function (e) {
    pe(),
      ...
      document.querySelector(".slider-rooms__body") &&
        new re(".slider-rooms__body", {
          modules: [ae, de],
          slidesPerView: 1,
          spaceBetween: 24,
          speed: 800,
          ...
          loopedSlides: 5,
          parallax: !0,
          pagination: { el: ".slider-rooms__dots", clickable: !0 },
          navigation: {
      ...
      document.querySelector(".slider-tips__body") &&
        new re(".slider-tips__body", {
          modules: [ae, de],
          observer: !0,
          observeParents: !0,
          slidesPerView: 3,
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              S = Ve(r, x || "", g, this.settings.strings.playVideo, h);
              n.prepend(S);
            } else if (h) {
  ...
  const Ke = function (e, t) {
    ...
    Qe = document.querySelectorAll(".lightgallery");
  Qe.length &&
    Qe.forEach((e) => {
      Ke(e, {
    ...
    (window.onload = function () {
      document.addEventListener("click", function (e) {
        const i = e.target;
        if (window.innerWidth > 768 && t.any()) {
          i.classList.contains("menu__arrow") &&
            i.closest(".menu__item").classList.toggle("_hover");
          let e = document.querySelectorAll(".menu__item._hover");
            ...
            if (!e.classList.contains("_hold")) {
              ...
              if (s.ok) {
                !(function (e) {
                  ...
                  e.remove();
              } else alert("Файл json не найден");
            }
          })(i));
      ...
      document.querySelectorAll(".actions-product__link").forEach(function (e) {
      ...
      function s(e, t, s = !0) {
        const i = document
            .querySelector(".cart-header")
            .querySelector(".cart-header__icon"),
          n = i.querySelector("span"),
          r = document.querySelector(`[data-cart-pid = "${t}"]`),
          o = document.querySelector(".cart-list");
        if (s) {
          if (
            (n
              ? (n.innerHTML = ++n.innerHTML)
              : i.insertAdjacentHTML("beforeend", "<span>1</span>"),
            r)
          ) {
            const e = r.querySelector(".cart-list__quantity span"),
          ...
          const e = r.querySelector(".cart-list__quantity span");
          (e.innerHTML = --e.innerHTML), parseInt(e.innerHTML) || r.remove();
          const t = --n.innerHTML;
          t ? (n.innerHTML = t) : n.remove();
        }
      }
      ...
      if (i && !t.any()) {
        const n = document.querySelector(".furniture__items"),
          r = document.querySelectorAll(".furniture__column"),
          o = i.dataset.speed;
        let a = 0,
          l = 0;
        function d() {
          ...
          const t = e - i.offsetWidth,
            s = Math.floor(l - a);
          a += s * o;
          let c = (t / 200) * a;
          (n.style.cssText = `transform: translate3d(${c}px, 0, 0)`),
            Math.abs(s) > 0
        ...
        i.addEventListener("mousemove", (e) => {
          ...
          (l = (s / t) * 200),
            i.classList.contains("_init") ||
              (requestAnimationFrame(d), i.classList.add("_init"));
        });
      }
    }),
    (function (e) {
